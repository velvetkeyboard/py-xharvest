...
class TimeEntryListBoxRow(Gtk.ListBoxRow):
    ...
    def __init__(self, data, app_start_time_entry_cb, app_stop_time_entry_cb):
        ...
        builder = Gtk.Builder()
        # builder.add_from_file('glade/main2.glade')
        builder.add_objects_from_file(GLADE_FILE, ('boxTimeEntry',))
        self.bind(builder)
...
class AppHandler(object):
    ...
    def render_authentication_window(self):
        builder = Gtk.Builder()
        builder.add_objects_from_file(GLADE_FILE, ('windowHarvestOAuth2Authorization',))
    ...
    def render_weekday_widget(self, data):
        builder = Gtk.Builder()
        builder.add_objects_from_file(GLADE_FILE, ('eventBoxWeekDay',))
