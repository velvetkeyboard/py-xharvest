...
class ShortcutsPreferencesHandler(Handler):
    ...
    def bind_data(self):
        ...
        #        f'{shortcuts["mod_key"]} + {shortcuts["new_time_entry"]}')
        #self.label_show_today_entries.set_label(
        #        f'{shortcuts["mod_key"]} + {shortcuts[Shortcuts.SHOW_TODAYS_ENTRIES]}')
        #self.label_show_time_summary.set_label(
        #        f'{shortcuts["mod_key"]} + {shortcuts[Shortcuts.SHOW_TIME_ENTRY_FORM]}')
