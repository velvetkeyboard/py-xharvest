...
GLADE_MAIN_HEADERBAR = pkg_resources.resource_filename(
    __name__, "glade/main_headerbar.glade"
)
GLADE_TIME_SUMMARY = pkg_resources.resource_filename(
    __name__, "glade/time_summary.glade"
)
